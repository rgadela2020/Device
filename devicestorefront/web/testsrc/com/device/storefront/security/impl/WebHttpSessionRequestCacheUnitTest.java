...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/devicestorefront/electronics/en",
						"https://electronics.local:9002/devicestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/devicestorefront/electronics/en",
						"https://electronics.local:9002/devicestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/devicestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/devicestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/devicestorefront/electronics/en",
						"https://electronics.local:9002/devicestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/devicestorefront",
						"https://electronics.local:9002/devicestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/devicestorefront",
						"https://electronics.local:9002/devicestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/devicestorefront/electronics/en",
						"https://electronics.local:9002/devicestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
