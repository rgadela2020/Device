...
import com.device.test.constants.DeviceTestConstants;
import com.device.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = DeviceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/devicetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/devicetest/import/reviews.impex");
			...
			importImpexFile(context, "/devicetest/import/cstickets.impex");
		}
	}
}
