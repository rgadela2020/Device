...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ApparelProduct",
			"Product",
			com.device.core.jalo.ApparelProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.device.core.jalo.ApparelStyleVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"ApparelStyleVariantProduct",
			com.device.core.jalo.ApparelSizeVariantProduct.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"VariantProduct",
			com.device.core.jalo.ElectronicsColorVariantProduct.class,
			null,
			false,
			null,
			false
