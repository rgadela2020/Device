 ...
 */
package com.device.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(DeviceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(DeviceFulfilmentProcessConstants.PARENT_PROCESS);
